...
var iconType = {
  viewBox: "0 0 24 24",
  paths: [{
    d: "M15 8c0-1.42-.5-2.73-1.33-3.76.42-.14.86-.24 1.33-.24 2.21 0 4 1.79 4 4s-1.79 4-4 4h-.18l-.77-.77c.6-.94.95-2.05.95-3.23zM7.24 4.41C7.77 4.15 8.37 4 9 4c2.21 0 4 1.79 4 4 0 .63-.15 1.23-.41 1.76zm13.95 16.78c.39.39.39 1.02 0 1.41s-1.02.39-1.41 0l-2.99-2.99c-.19.24-.47.39-.79.39H2c-.55 0-1-.45-1-1v-2c0-2.66 5.33-4 8-4 .37 0 .8.03 1.25.08L9.17 12H9c-2.21 0-4-1.79-4-4v-.17L1.39 4.22C1 3.83 1 3.2 1.39 2.81s1.02-.39 1.41 0zm-2.3-5.12c-.29-1.22-1.13-2.19-2.23-2.94 2.76.4 6.34 1.69 6.34 3.87v2c0 .32-.15.6-.38.79z"
  }],
  circles: []
};
var GroupOffIcon = function GroupOffIcon(props) {
  return renderIcon(props, iconType);
};

export { GroupOffIcon };
//# sourceMappingURL=GroupOffIcon.esm.js.map
